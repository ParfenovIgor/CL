...
void TypeSubstitute_ArrayType   (Type*&, Ident&, Type*);
...
void TypeSubstitute(Type *&expr, Ident &ident, Type *value) {
    ...
    if (dynamic_cast <ArrayType*> (expr)) {
        TypeSubstitute_ArrayType(expr, ident, value); return;
    }
...
void TypeSubstitute_ArrayType(Type *&expr, Ident &ident, Type *value) {
    ArrayType *array_type = dynamic_cast <ArrayType*> (expr);
    TypeSubstitute(array_type->type_, ident, value);
}
