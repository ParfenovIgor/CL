...
/********************   WhereField    ********************/
WhereField::WhereField(Ident p1, Type *p2, Expr *p3)
{
  ident_ = p1;
  type_ = p2;
  expr_ = p3;
...
/********************   MoveAssignment    ********************/
MoveAssignment::MoveAssignment(Expr *p1, Expr *p2)
{
  expr_1 = p1;
  expr_2 = p2;
...
MoveAssignment::MoveAssignment(const MoveAssignment & other)
{
  expr_1 = other.expr_1->clone();
  expr_2 = other.expr_2->clone();
...
MoveAssignment &MoveAssignment::operator=(const MoveAssignment & other)
{
  MoveAssignment tmp(other);
  swap(tmp);
  return *this;
}

void MoveAssignment::swap(MoveAssignment & other)
{
  std::swap(expr_1, other.expr_1);
  std::swap(expr_2, other.expr_2);
...
void MoveAssignment::accept(Visitor *v)
{
  v->visitMoveAssignment(this);
}

MoveAssignment *MoveAssignment::clone() const
{
  return new MoveAssignment(*this);
}



/********************   CopyAssignment    ********************/
CopyAssignment::CopyAssignment(Expr *p1, Expr *p2)
{
  expr_1 = p1;
  expr_2 = p2;
...
CopyAssignment::CopyAssignment(const CopyAssignment & other)
{
  expr_1 = other.expr_1->clone();
  expr_2 = other.expr_2->clone();
...
CopyAssignment &CopyAssignment::operator=(const CopyAssignment & other)
{
  CopyAssignment tmp(other);
  swap(tmp);
  return *this;
}

void CopyAssignment::swap(CopyAssignment & other)
{
  std::swap(expr_1, other.expr_1);
  std::swap(expr_2, other.expr_2);
...
void CopyAssignment::accept(Visitor *v)
{
  v->visitCopyAssignment(this);
}

CopyAssignment *CopyAssignment::clone() const
{
